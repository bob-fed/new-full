                  ...
                  {filteredConversations.map((conversation) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`w-full p-4 text-left cursor-pointer transition-all duration-200 ${
                          isSelected 
                ...
                <div className="sticky bottom-0 p-4 bg-white border-t border-gray-200">
                  <div className="flex items-end space-x-3">
                    ...
                    <div className="flex-1 relative">
                      ...
                      <button 
                        onClick={handleEmoji}
                        className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 text-gray-500 hover:bg-gray-200 rounded-lg transition-colors"
                      >
                    ...
                    <button
                      ...
                      className="w-12 h-12 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed rounded-full p-0 flex items-center justify-center transition-colors"
                    >
